...
const PatientProfile = () => {
    ...
    const formattedDate = formatDate(new Date(patient[0].date_of_birth))
    ...
    return (        
        <section role="list" className="rounded-3xl p-5 bg-white divide-y divide-gray-100">
            <div className="grid grid-cols-1 justify-items-center gap-6 pb-4">
                <img className="pt-4 w-3/4" src={patient[0].profile_picture} alt="" />
                <h2 className="text-2xl font-medium" >{patient[0].name}</h2>
                <div className="w-full grid grid-cols-6 gap-8 grid-rows-1" >
                    ...
                    <div className="col-span-5" >
                        ...
                        <p className=" font-semibold">{patient[0].gender}</p>
                    </div>
                    <div className="col-span-1 text-center m-auto bg-gray-100 p-0.5 rounded-full">
                        <PhoneIcon />
                    </div>
                    <div className="col-span-5" >
                        ...
                        <p className=" font-semibold">{patient[0].phone_number}</p>
                    </div>
                    <div className="col-span-1 text-center m-auto bg-gray-100 p-0.5 rounded-full">
                        <PhoneIcon />
                    </div>
                    <div className="col-span-5" >
                        ...
                        <p className=" font-semibold">{patient[0].emergency_contact}</p>
                    </div>
                    <div className="col-span-1 text-center m-auto bg-gray-100 p-0.5 rounded-full">
                        <InsuranceIcon />
                    </div>
                    <div className="col-span-5" >
                        ...
                        <p className=" font-semibold">{patient[0].insurance_type}</p>
                    </div>
                </div>
